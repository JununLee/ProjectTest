...
Shader "Unlit/X_rayProjector"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{ 
				float val = 0;
				float3 origin = i.worldPos - normalize(i.worldNorml);
				float3 dir = normalize(i.worldNorml);
				...
				float maxSamples = 512;
				float currentSample = 0;
				float steplength = 1.412 / maxSamples ;
				...
				float4 cc = tex3Dlod(_VolumeTex, float4(i.uv.x,i.uv.y,_Slider/10, 0));
				val = cc.a > 0 ? cc.a : 0;
