	...
	) : SV_Target
{
		...
		clip (alpha - alphaTest);		
				...
				half alphaRef = tex3D(_DitherMaskLOD, float3(vpos.xy*0.25,alpha*_Color.a*0.9375)).a;
				clip (alphaRef - alphaTest);
			#endif // #ifdef UNITY_STANDARD_USE_DITHER_MASK
		#endif // #if defined(_ALPHABLEND_ON)
