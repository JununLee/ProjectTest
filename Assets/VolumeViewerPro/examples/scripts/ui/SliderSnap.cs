...
///                         to set multiple values to snap to and how
///                         strong they should snap.
...
public class SliderSnap : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
{
